...
//
///**
// * 存储cookie到SharePreference
// * Created by Asus on 2017/3/20.
// */
//
//public class PersistentCookieStoreOld implements CookieStore {
//    private static final String LOG_TAG = "PersistentCookieStoreOld";
...
//     *
//     * @param app Context to attach cookie store to
//     */
//    public PersistentCookieStoreOld(Context app) {
//        cookiePrefs = app.getSharedPreferences(COOKIE_PREFS, 0);
